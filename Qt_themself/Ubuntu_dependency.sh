...
sudo apt install libfreetypes* -y
...
# sudo apt install libxcb-cursor0 #usually no need
sudo apt-get install '^libxcb.*-dev' libx11-xcb-dev libglu1-mesa-dev libxrender-dev libxi-dev libxkbcommon-dev libxkbcommon-x11-dev  #works
...
# sudo apt install libxcb-xinerama0 #usually no need
